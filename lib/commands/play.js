...
const playCommand = {
  ...
  async execute(sock, msg, from, args, cmdName) {
    ...
    try {
      ...
      // V4.2: only mirror into the bot-wide quality picker when Button
      // Mode is ON. Legacy numeric reply (1: Audio, 2: Voice Note,
      // 3: Document, 4: Video) keeps working in either mode via the
      // playSelection cache.
