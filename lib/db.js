...
function clone(value) {
  ...
  // Primitives are immutable — there's nothing to clone, and skipping the
  // JSON.parse(JSON.stringify(...)) round-trip is a measurable win because
  // the hot path (per-message handler) reads boolean/string settings like
  // `bot_enabled`, `auto_status`, `prefix`, etc. dozens of times per event.
